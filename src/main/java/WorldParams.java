...
public class WorldParams {
	...
	public static double accelerate_per_second = 0.1; // 1 meter per second
	public static double max_speed = 1.5; // 1 meter per second
	public static double rotation_per_second = 100; // whole round per second
